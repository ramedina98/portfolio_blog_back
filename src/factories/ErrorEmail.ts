...
class ErrorEmail implements EmailBaseMethods {
    ...
    async send(): Promise<void> {
        ...
        try {
            ...
            const response = await this.emailService.sendEmail(this.email, subject, htmlTemplate);
            ...
            const adminResponse = await this.emailService.sendEmail(SERVER.EMAIL, adminSubject, adminMessage);
